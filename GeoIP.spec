...
%description -l pl
GeoIP jest bibliotek± napisan± w C umo¿liwiaj±c± u¿ytkownikowi odnalezienie
pañstwa, z którego dany adres IP lub domena pochodzi. U¿ywa do tego
zapisanej w pliku bazy danych (z Marca 2003). W bazie tej adresy IP s±
kluczami, a pañstwa warto¶ciami. Powinna ona byæ dok³adniejsza ni¿
zapytania o odwrotny DNS. Komercyjne bazy oraz us³ugi automatycznych
aktualizacji dostêpne s± na stronie http://www.maxmind.com/

Modu³ ten mo¿e byæ u¿yty to automatycznego wyboru najbli¿szego mirroru,
analizy logów serwera WWW w celu okre¶lenia kraju, z jakiego pochodz± osoby
odwiedzaj±ce serwis, do wykrywania oszustw dotycz±cych kart kredytowych, i
do kontroli eksportu oprogramowania.
